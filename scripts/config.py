...
PUBLIC_DIR = ROOT / "public"      # served by GitHub Pages as android.avar.me
...
SCHEMA_VERSION = 1
SITE_BASE_URL = "https://android.avar.me"

# Minimum Android app version (versionName) able to read this dictionary schema.
